...
export const QuickQuestionButton: React.FC<QuickQuestionButtonProps> = ({
  ...
  const availabilityUrl = getWhatsappUrl(buildProductAvailabilityWhatsappMessage(product));
  const scentProfileUrl = getWhatsappUrl(buildProductScentProfileWhatsappMessage(product));
  const generalUrl = getWhatsappUrl(buildQuickQuestionWhatsappMessage(product, 'general'));
    ...
    return (
      <div className={`relative ${className}`}>
        <a
          ...
          title="سؤال سريع عن التوفر أو الرائحة عبر واتساب"
        >
      ...
      <div className="p-3.5 sm:p-4">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-500 mt-0.5">
                استفسر فوراً عبر واتساب عن التوفر بالمحل أو النوتات والثبات
              </p>
            </div>
          </div>
          ...
          <button
            ...
            aria-label="عرض خيارات الاستفسار"
          >
            <ChevronDown
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-3 pt-2 border-t border-gray-200/60">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center justify-between p-2.5 rounded-xl bg-white hover:bg-amber-50 border border-gray-200 hover:border-amber-300 text-right transition-all shadow-2xs hover:shadow-xs"
          >
            <div className="flex items-center gap-2">
              ...
              <div>
                <span className="block text-xs font-bold text-[#1A1A1A] group-hover:text-amber-900">
                  استفسار عن الرائحة والنوتات
                </span>
                <span className="text-[10px] text-gray-500">الثبات، الفوحان، الطابع</span>
              </div>
            </div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center justify-between p-2.5 rounded-xl bg-white hover:bg-emerald-50 border border-gray-200 hover:border-emerald-300 text-right transition-all shadow-2xs hover:shadow-xs"
          >
            <div className="flex items-center gap-2">
              ...
              <div>
                <span className="block text-xs font-bold text-[#1A1A1A] group-hover:text-emerald-900">
                  استفسار عن التوفر والشحن
                </span>
                <span className="text-[10px] text-gray-500">المخزن، الشحن لمدينتك</span>
              </div>
            </div>
            <MessageCircle className="w-3.5 h-3.5 text-[#25D366] shrink-0 opacity-80 group-hover:opacity-100" />
          </a>
          ...
          <div className="mt-3 pt-3 border-t border-gray-200/70 text-xs text-gray-600 space-y-2 animate-fadeIn">
            <div className="flex items-start gap-2 bg-white/80 p-2.5 rounded-xl border border-gray-200">
              ...
              <p className="text-[11px] leading-relaxed">
                يتم إرسال رسالة جاهزة تلقائياً تحتوي على اسم المنتج{' '}
                <strong className="text-[#1A1A1A]">"{product.name}"</strong> وسعره، ليقوم خبير
                العطور لدينا بالإجابة على استفسارك ومساعدتك في الاختيار مباشرة عبر واتساب.
              </p>
            </div>
            ...
            >
              ...
              <span>فتح محادثة عامة حول المنتج عبر واتساب</span>
