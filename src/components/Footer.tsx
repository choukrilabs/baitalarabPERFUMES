...
export const Footer: React.FC<FooterProps> = ({ onOpenAdmin, onSelectCategory }) => {
  ...
  return (
    <footer className="bg-[#0A0A0A] text-gray-400 pt-16 pb-8 border-t border-[#C6A664]/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-12 border-b border-[#8C7342]/20">
          ...
          <div className="space-y-4 md:col-span-2">
            ...
            <div className="flex items-center gap-2 text-xs text-[#C6A664]">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-sm">
              ...
              <a
                ...
                className="flex items-center gap-2 text-gray-400 hover:text-[#C6A664] transition-colors dir-ltr justify-end"
              >
              ...
              <div className="flex items-center gap-3 pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-full bg-[#2A2A2A] text-[#C6A664] hover:bg-[#C6A664] hover:text-white flex items-center justify-center transition-colors shadow"
                  aria-label="إنستغرام"
                >
        ...
        {/* Bottom Copyright */}
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-center text-xs text-gray-600 gap-4">
