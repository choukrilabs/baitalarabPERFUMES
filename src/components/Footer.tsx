...
export const Footer: React.FC<FooterProps> = ({ onOpenAdmin, onSelectCategory, onNavigateHome }) => {
  ...
  return (
    <footer className="bg-[#0A0A0A] text-gray-400 pt-16 pb-8 border-t border-[#8C7342]/30" dir={isFrench ? 'ltr' : 'rtl'}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-12 border-b border-[#8C7342]/20">
          ...
          <div className="space-y-4 md:col-span-2">
            ...
            <div className="flex items-center gap-2 text-xs text-[#8C7342]">
              ...
              <span>{isFrench ? 'Rue Moulay Ismaïl, Quartier des Habous • Casablanca' : `${SHOP_CONFIG.address} • ${SHOP_CONFIG.city}`}</span>
            </div>
